...
def test_create_azure_client_rest(request_type):
    ...
    request_init["azure_client"] = {'name': 'name_value', 'tenant_id': 'tenant_id_value', 'application_id': 'application_id_value', 'annotations': {}, 'pem_certificate': 'pem_certificate_value', 'uid': 'uid_value', 'create_time': {'seconds': 751, 'nanos': 543}}
