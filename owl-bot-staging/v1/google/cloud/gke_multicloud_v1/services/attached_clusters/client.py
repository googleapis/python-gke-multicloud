...
class AttachedClustersClient(metaclass=AttachedClustersClientMeta):
    ...
    @staticmethod
    def attached_cluster_path(project: str,location: str,attached_cluster: str,) -> str:
        """Returns a fully-qualified attached_cluster string."""
        return "projects/{project}/locations/{location}/attachedClusters/{attached_cluster}".format(project=project, location=location, attached_cluster=attached_cluster, )
    ...
    @staticmethod
    def attached_server_config_path(project: str,location: str,) -> str:
        """Returns a fully-qualified attached_server_config string."""
        return "projects/{project}/locations/{location}/attachedServerConfig".format(project=project, location=location, )
    ...
    def create_attached_cluster(self,
    ...
    def update_attached_cluster(self,
    ...
    def import_attached_cluster(self,
    ...
    def list_attached_clusters(self,
    ...
    def delete_attached_cluster(self,
    ...
    def get_attached_server_config(self,
    ...
    def generate_attached_cluster_install_manifest(self,
